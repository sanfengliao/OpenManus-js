import { NormalPythonExecute } from './python-execute'

/**
 * A tool for Chart Generation Preparation
 */
export class VisualizationPrepare extends NormalPythonExecute {
  name = 'visualization_preparation'
  description = 'Using Python code to generates metadata of data_visualization tool. Outputs: 1) JSON Information. 2) Cleaned CSV data files (Optional).'
  parameters = {
    type: 'object',
    properties: {
      code_type: {
